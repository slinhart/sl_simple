...
var WebReaderError = function (_Error) {
  _inherits(WebReaderError, _Error);
  ...
  function WebReaderError(message) {
     ...
     *
     * @TODO: Change in this.constructor.name when Babel will support the correct transpilation.
     * @TODO: this.constructor.name should be WebReaderError but Babel returns Error
     */

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WebReaderError).call(this, message));

    _this.name = 'WebReaderError';
    return _this;
  }

  return WebReaderError;
}(Error);
